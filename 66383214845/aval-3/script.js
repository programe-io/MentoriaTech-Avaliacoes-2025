/*
  Robust loader:
    - for each <img data-srcs="url1|url2|..."> try urls in order
      - on first success set img.src and write debug info
        - if none succeed, hide img and show placeholder SVG
          Also loads avatar from multiple sources with fallback
          */
