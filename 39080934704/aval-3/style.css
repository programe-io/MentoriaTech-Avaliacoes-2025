...
<body>
    ...
    <main>
      <section aria-label="Artigos">
        ...
        <article class="cartao" id="post1">
          ...
          <img src=https://share.google/images/wh2C9IebsGrdiC9G7?auto=format&fit=crop&w=800&q=60" alt="Pessoa fazendo treino de corpo inteiro" style="width:100%; border-radius:10px; margin-bottom:10px;">
        ...
        <article class="cartao" id="post2">
          ...
          <img src="https://share.google/images/wh2C9IebsGrdiC9G7?auto=format&fit=crop&w=800&q=60" alt="Alimentos saudáveis para pré-treino" style="width:100%; border-radius:10px; margin-bottom:10px;">
        ...
        <article class="cartao destaque" id="post3">
          ...
          <img src="https://share.google/images/wh2C9IebsGrdiC9G7" alt="Pessoa planejando treino com planilha" style="width:100%; border-radius:10px; margin-bottom:10px;">
  ...
  <footer>
    <div class="limite">
      ...
      <p style="opacity:.7; margin-top:10px">©️ 2025 Academia Fitness Pro. Todos os direitos reservados.</p>
    </div>
  </footer>
